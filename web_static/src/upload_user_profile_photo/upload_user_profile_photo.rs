use super::upload_user_profile_photo_statement::*;
#[derive(serde::Deserialize, serde::Serialize)]
pub struct UploadUserProfilePhotoInfo {
    username: String,
    profile_photo_url: String,
}
impl UploadUserProfilePhotoInfo {
    pub fn new() -> Self {
        UploadUserProfilePhotoInfo {
            username: String::new(),
            profile_photo_url: String::new(),
        }
    }
    //检查下载文件是否成功并返回数据
    pub fn check_and_return_info(
        &self,
